...
namespace KeySending
{
     ...
     *
     * @param modifierFlags  Modifier flags to apply to the key, as defined in
     *                       Modifiers.h.
     *
     * @param targetWindow   The ID of the window where the key event should be
     *                       sent.
     */
     ...
     */
    void sendBufferedInput(Input::Buffer& inputBuffer, const int targetWindow);
